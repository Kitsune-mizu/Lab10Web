...
// Query untuk statistik menggunakan Database class
    ...
    <div class="recent-section">
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?php echo BASE_URL; ?>/barang/list" class="btn btn-sm btn-primary">
                    Lihat Semua
                </a>
            </div>
            <div class="card-body">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="action-grid">
                <a href="<?php echo BASE_URL; ?>/barang/add" class="action-card">
                ...
                <a href="<?php echo BASE_URL; ?>/barang/list" class="action-card">
                    <div class="action-icon">
                        <i class="fas fa-list"></i>
                    </div>
                    <div class="action-info">
