...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($error)) {
        ...
        if ($db->update('data_barang', $updateData, "id_barang = '$id'")) {
            header('Location: ' . BASE_URL . '/barang/list?message=' . urlencode('Barang berhasil diupdate!') . '&type=success');
            exit;
        } else {
...
<div class="page-header">
    ...
    <a href="<?php echo BASE_URL; ?>/barang/list" class="btn btn-secondary">
